...
<BODY>
        ...
        <a  id="signout" href="logout.php" class="btn btn-danger ml-3"><button type="button">Sign Out</button></a>
    

<!-- Cart ---->
<div id="shopping-cart">
<div class="txt-heading"><h1>eShop</h1></div>




<td   > <a id="empty" href="shop.php?action=empty" ><button type="button">Empty Cart</button></a></td>
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="shop.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><button type="button">Delete</button></a></td>
				</tr>
				<?php
...
<div id="product-grid">
	...
	?>
		<div class="product-item">
			<form method="post" action="shop.php?action=add&pid=<?php echo $row["id"]; ?>">
